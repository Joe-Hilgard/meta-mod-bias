...
*Null Model*
```{r}
null.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5)
...
*add* number to add to each group when collecting more data | adds some more data (*add* observations) and checks again
```{r}
QRP.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, QRP = 1)
QRPr = rma(yi = d, sei = se, data = QRP.data)

sel.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, sel = 1)
selr = rma(yi = d, sei = se, data = sel.data)

propB.data = dataMA(k = 10, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, propB = .6, sel = 1)

cbdv.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, cbdv = .3)
cbdvr = rma(yi = d, sei = se, data = cbdv.data)

multDV.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, multDV = 1)
multDVr = rma(yi = d, sei = se, data = multDV.data)

out.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, out = 1)
outr = rma(yi = d, sei = se, data = out.data)

mod.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, mod = 1)
modr = rma(yi = d, sei = se, data = mod.data)

colLim.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, colLim = 3)
colLimr = rma(yi = d, sei = se, data = colLim.data)

add.data = dataMA(k = 100, meanD = 0, sigma = .002, maxN = 50, minN = 20, meanN = 30, sdN = 5, add = 3)
