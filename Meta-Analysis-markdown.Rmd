...
modMA <- function(k, selProp, qrpEnv, empN.boost) {
...
set.seed(42069)
meta1.data <- modMA(k = 20, selProp = .5, qrpEnv = "high", empN.boost = .1)
...
*Null Model*
```{r}
null.data = dataMA(k = 10, delta = 0, tau = 0, 
               empN = 0, maxN = 200, minN = 20, meanN = 50, 
               selProp = 0, qrpEnv = "none", empN.boost = 0)
