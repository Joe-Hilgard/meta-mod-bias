...
# function to make various visuals of MA: (not working)

visualizeMA <- function(dataset){
  visu.data = funnel(dataset, level=c(90, 95, 99), 
        shade = c("white", "grey75", "grey60"), refline=0) 
  TF.visu.data = funnel(trimfill(dataset), refline = 0)
  #output
  return(visu.data, TF.visu.data)
}
