...
- Read this paper -- it's an interesting one that will teach you about p-curve and the Hedges-Vevea selection model.

- Think of a better way to plot these things, especially power. Maybe we put estimator on a facet_wrap or facet_grid so that readers can see overplotting of bias vs nobias.
...
- Discussion: Try to draw some broader lessons. Which estimators should be used? How badly does pub bias screw up moderator analysis? Should reviewers ask for PET + moderation? Hedges + moderation?
